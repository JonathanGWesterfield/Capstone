...
import sys
import os, time
from Controllers.Exceptions import RecordingNotStartedException, TransferNotStartedException, PhonesNotSyncedException
...
# def main():
#     # Do this part in Verify Setup
#     test = PhoneControl(8000)
#     test.sync()
#     time.sleep(1)
#
#     # Attach this part to the start button
#     # Look for exceptions and display as message boxes to the user
#     test.startRecording()
#     time.sleep(10)
#
#     # Attach this part to stop button
#     test.stopRecording()
#     test.startFileTransfer("/Users/hayleyeckert/Desktop/FTP/")
#     time.sleep(1)
#     test.waitForFileTransfer()
#
#     # Do this when the UI closes
#     test.closeConn()
#
