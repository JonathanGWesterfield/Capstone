...
class Controller:
    ...
    def show_home(self):
        ...
        # Prints file path
        # TODO: Pass this file into the report function.
        self.home.sigImportFlight.connect(print)
    ...
    def get_flight_info(self, str1: str, str2: str, str3: str):
        """
         Saves the pilot name, instructor name, and flight instructions once confirmed by the user.
         :return: None
         """
        self.pilotName = str1
        self.instructorName = str2
        self.flightInstructions = str3
    ...
    def show_loading_window(self):
        ...
        self.loading_window.sigTestReport.connect(self.show_report_window)
